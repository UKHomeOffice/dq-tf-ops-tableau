...
class TestE2E(unittest.TestCase):
    ...
    def test_name_tableau_deployment(self):
        self.assertEqual(self.result['tableau']["aws_instance.tableau_deployment"]["tags.Name"], "ec2-deployment-tableau-ops-preprod-dq")
